import { Box, Button, Typography, useTheme, Backdrop, Card, CardContent, CardActions, Table,TableRow, TableHead, TableBody, TableContainer, TableCell } from "@mui/material"
...
const columns = [
    {
        ...
        headerName:'#',
        filterable:false,
        renderCell:(index) => index.api.getRowIndexRelativeToVisibleRows(index.row.code) + 1
    },
    {
        field:'task name',
        ...
        <>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', padding:'32px' }}>
                <Box sx={{ maxWidth: (theme) => theme.breakpoints.values.lg, width:'100%' }}>
                    {/* {currentUser.tasks.length < 1 &&
                        <div style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            ...
                            <Backdrop
                                ...
                                <Card sx={{}}>
                                    <CardContent>
                                        <Typography>You'll be redirected to another page to create a new task.</Typography>
                                        <br/>
                                        <Typography textAlign="center" >Do you wish to proceed ?</Typography>
                                    </CardContent>
                                    <CardActions sx={{display:'flex', justifyContent:'center'}}>
                                        <Button onClick={()=>setCreateTaskDialogOpen(false)} variant="contained" sx={{py:0.5, mr:3}}>No</Button>
                                        <Button onClick={()=>navigate('/createTask')} variant="contained" sx={{py:0.5}}>Yes</Button>
                                    </CardActions>
                                </Card>
                            </Backdrop>
                        </div>
                                ...
                                <Table stickyHeader>
                                    <TableHead>
                                        <TableRow>
                                            ...
                                            <TableCell>No. of times used</TableCell>
                    ...
                    <Box sx={{backgroundColor:'#fff', width:'100%', height:'2px'}}></Box>
                </Box>
            </div>
        </>
    )
...
export const getTasks = async () => {
    const res = await fetch('http://192.168.0.109:3000/getTasks')
